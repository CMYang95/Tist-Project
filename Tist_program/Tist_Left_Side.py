...
#抓鏡頭或是影片
cap= cv2.VideoCapture(r"D:\TIST_PROJECT\Tist_vide\Sun_Jerk3.mp4")      
#抓影片的大小fps等資訊
...
with mp_pose.Pose(min_detection_confidence=0.8, min_tracking_confidence=0.8) as pose: 
    ...
    for timestamp in timestamps:
        ...
        mp_drawing.draw_landmarks(image, results.pose_landmarks, mp_pose.POSE_CONNECTIONS,
                                ...
                                mp_drawing.DrawingSpec(color=(245,33,240), thickness=2,circle_radius=1))
    ...
    #肩膀平衡等等可改
        ...
        cv2.putText(image, f"Force: {force:.2f} N", 
                    (39,140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (64,224,208), 2)
